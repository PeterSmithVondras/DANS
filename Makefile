...
$(COM_DS)test_multiqueue: $(COM_DS)test_multiqueue.cpp $(COM_DS)job.o \
		$(COM_DS)multiqueue.o
	$(XX) -o $@ $< $(CXXFLAGS) $(LFLAGS) \
		$(COM_DS)job.o $(COM_DS)multiqueue.o
...
$(COM_DS)test_dispatcher: $(COM_DS)test_dispatcher.cpp $(COM_DS)dispatcher.o \
		$(COM_DS)job.o $(COM_DS)multiqueue.o
	$(XX) -o $@ $< $(CXXFLAGS) $(LFLAGS) \
		$(COM_DS)dispatcher.o $(COM_DS)job.o $(COM_DS)multiqueue.o
...
$(COM_DS)test_duplicatestage: $(COM_DS)test_duplicatestage.cpp $(COM_DS)job.o \
		$(COM_DS)multiqueue.o  $(COM_DS)dispatcher.o
	$(XX) -o $@ $< $(CXXFLAGS) $(LFLAGS) \
		$(COM_DS)job.o $(COM_DS)multiqueue.o  $(COM_DS)dispatcher.o
